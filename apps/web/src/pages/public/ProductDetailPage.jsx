      ...
      >
        <div style={{ display: "grid", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <Link to="/cart" style={{ display: "inline-flex", padding: "14px 18px", borderRadius: 18, background: "var(--color-accent)", color: "#ffffff", fontWeight: 800, textDecoration: "none" }}>
              Đi đến giỏ hàng
            </Link>
            <Link to="/pc-builder" style={{ display: "inline-flex", padding: "14px 18px", borderRadius: 18, border: "1px solid var(--border)", background: "rgba(255,255,255,0.74)", color: "var(--text)", fontWeight: 800, textDecoration: "none" }}>
              Đưa vào PC Builder
            </Link>
        ...
        <div
          style={{
            ...
            background: product?.image_url ? `center / cover no-repeat url(${product.image_url})` : "radial-gradient(circle at top, rgba(198,124,49,0.26), transparent 38%), linear-gradient(135deg, #f7ead8, #deece5)",
            display: "grid",
            placeItems: "center",
            color: "var(--primary)",
            fontSize: 26,
        ...
        >
          {!product?.image_url ? (product?.category?.name || product?.category_name || "Sản phẩm") : null}
        </div>
      </section>
